...
revoke all on function public.get_catalog_agent_auto_apply_diagnostics() from public, anon;
grant execute on function public.get_catalog_agent_auto_apply_diagnostics() to authenticated, service_role;
