...
- TestFlight distribution uses a signed Archive/export/upload flow; the current staging candidate is `1.0.1 (3)`.
...
- TestFlight candidate `1.0.1 (3)` is the current bugfix candidate from Release configuration.
