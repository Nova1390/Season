...
- [Catalog Agent Autonomy Roadmap](docs/catalog-agent-autonomy-roadmap.md): staged path from 4.0 supervised autonomy to 8.0+ multi-market catalog stewardship.
