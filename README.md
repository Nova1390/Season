...
- TestFlight distribution uses a signed Archive/export/upload flow; the current staging candidate is `1.0.1 (2)`.
...
- TestFlight candidate `1.0.1 (2)` has been archived/uploaded from Release configuration.
